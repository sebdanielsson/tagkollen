...
final class ActivityBackgroundRefresher: NSObject {
    static let sessionIdentifier = (Bundle.main.bundleIdentifier ?? "se.tagradar.app") + ".activity-refresh"
    ...
    private let logger = Logger(subsystem: "se.tagradar.app", category: "ActivityRefresh")
